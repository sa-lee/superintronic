...
Report coverage summary values per gene of:
	...
	Number of intronic bases above THRESHOLD, where THRESHOLD is an appropriate coverage value defining moderately expressed exonic region. 
Histogram (or equivalent) of coverage in exonic regions. 